        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                if (opc.equalsIgnoreCase("agregar")) {
                    ...
                    response.sendRedirect("Vistas/Analista/Servicio.jsp?valSer=correcto");
                }
                if(opc.equalsIgnoreCase("mod")){
                    int id = Integer.parseInt(request.getParameter("id"));
                    OpcionesServicios.Actualizar(ser, id);
                    response.sendRedirect("Vistas/Analista/Servicio.jsp?valMod=correcto");
                }
