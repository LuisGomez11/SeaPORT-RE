            ...
            <div class="formOpcio container p-5">
                <div class="row">
                    <div class="form-group col-md-4">
                        <h3>Servicio generado con referencia: </h3>
                    ...
                    <div class="form-group col-md-8">
                        ...
                        <br>
                        <div class="d-flex">
                            <div class="col-md-6"><input type="submit" name="btnEliminar" value="ELIMINAR" class="btn btn-info btn-block"></div>
                            <div class="col-md-6"><a class="btn btn-danger btn-block" href="../../Generados.jsp">CANCELAR</a></div>                            
                        </div>
                    </div>
                </div>
        ...
        <%
            if (request.getParameter("btnEliminar") != null) {
                ...
                if (contra.equals("passanalista")) {
                    OpcionesGenerados.Eliminar(ref);
                    response.sendRedirect("../../Generados.jsp?valEli=correcto");
                } else {
